        ...
        <div className="traffic-summary">
            <div className="traffic-summary-info">
                ...
                <div className="traffic-summary-val">
                    <span className="val-text">5929</span>
            ...
            <div className="traffic-summary-statdata">
                ...
                <span className="statdata-value">75.34$</span>
            </div>
        </div>
        <div className="traffic-content">
            <div className="bar-chart-block">
                <ResponsiveContainer width="100%" height = '100%'>
                    <BarChart data={DAILY_TRAFFIC_DATA} margin = {{
                        ...
                        <Bar dataKey = "visitor" fill = {theme.colors.majorelleBlue} barSize = {16} radius = {[10, 10, 10, 10]} />
                        <Tooltip cursor = {{
                            fill: "transparent",
                        }} />
                    </BarChart>
