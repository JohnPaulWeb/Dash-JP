  ...
  return (
    <YourPieChartWrap>
        <div className="your-piechart-head">
            <h3 className="head-ttl">This is Pie Chart</h3>
            ...
            <div className="pie-chart-block">
                <ResponsiveContainer width = "100%" height = "100%">
                    <PieChart width = {400} height = {400}>
                        <Pie data={PIE_CHART_DATA} cx = "50%" cy = "50%" labelLine = {false} label = {renderCustomizedLabel} outerRadius={80} dataKey="value">
                            {
                        ...
                        return (
                            <div className="info-item" key = {index}>
                                <div className="info-item-head">
                                    <div className="info-item-dot" style = {{
                                        background: `${COLORS [index]}`
                                    }}></div>
                                    <span className="info-item-ttl">{dataItem.name}</span>
                                </div>
                                <div className="info-item-val">{dataItem.value}%
